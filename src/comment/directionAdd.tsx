...
export default function DirectionAdd({ Add }: any) {
    ...
    return (
        <div>
            ...
            <Modal title="产品方向" open={isModalOpen} onOk={handleOk} onCancel={handleCancel} footer={null}>
                <Form
                    ref={form}
                    name="basic"
                    labelCol={{ span: 8 }}
                ...
                >
                    <Form.Item
                        ...
                        rules={[{ required: true, message: '产品方向不能为空' }]}
                    >
                        <Input />
                    </Form.Item>
